...
class LunaTrainer:
    ...
    def __init__(self, model_name, config):
        ...
        # Inicializar atributos usados em _adjust_hyperparams_for_hardware
        self.batch_size = getattr(self.config.training, "per_device_train_batch_size", 4)
    ...
    def train_supervised(self, train_data, valid_data=None, use_wandb=False, num_train_epochs=None, output_dir=None, dynamic_hp_opt=False):
        ...
        try:
            ...
            # Configurar wandb se solicitado
            if use_wandb:
