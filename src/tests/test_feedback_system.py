...
class TestFeedbackSystem(unittest.TestCase):
    ...
    def test_save_feedback(self):
        ...
        self.feedback_system.add_feedback("Test prompt", "Test response", 5)
        self.feedback_system._save_feedback()
    ...
    def test_needs_update(self):
        ...
        self.config.feedback.min_samples_for_update = 3
        
        # Adicionar feedbacks insuficientes
        self.feedback_system.add_feedback("Prompt 1", "Response 1", 5)
        self.feedback_system.add_feedback("Prompt 2", "Response 2", 5)
        self.assertFalse(self.feedback_system.needs_update())
        
        # Adicionar feedback suficiente
        self.feedback_system.add_feedback("Prompt 3", "Response 3", 5)
