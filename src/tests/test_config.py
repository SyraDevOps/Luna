...
class TestConfig(unittest.TestCase):
    ...
    def test_config_loading(self):
        ...
        self.assertEqual(config.persona.default_persona, "casual")
    ...
    def test_config_validation(self):
        ...
        # Criar uma configuração válida para teste
        config_data = {
            "model": {
                "vocab_size": 5000,
                "hidden_size": 512,
        ...
        # Aplicar dados de configuração manualmente
        config.model.vocab_size = config_data["model"]["vocab_size"]
        config.model.hidden_size = config_data["model"]["hidden_size"]
        config.model.num_hidden_layers = config_data["model"]["num_hidden_layers"]
        config.training.per_device_train_batch_size = config_data["training"]["per_device_train_batch_size"]
        config.training.learning_rate = config_data["training"]["learning_rate"]
        ...
        self.assertGreater(config.training.per_device_train_batch_size, 0)
